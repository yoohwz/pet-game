...
Tests: **156 passed, 0 failed**. Includes migration, validation, care effects/clamps, low-energy/sleep rejection, persistence failures, offline sleep, event identity and Phase 0–2 regressions.
